...
plot_data(df_by_gene[1][1]["Predicted_Zeta"], df_by_gene[1][1]["GLM_Combined_Zeta"], zeta_plot1, df_by_gene[1][0])

metrics = []

avg_loss = f"Average Loss: {df['Loss'].mean()}\n"
sum_loss = f"Summed Loss: {df['Loss'].sum()}\n"
